...
namespace RingGeneral_console
{
    class MatchControl : SegmentControl
    {
        ...
        public void AddMember(Character member, int side)
        {
            ...
            SideList[side - 1].AddMember(new MatchMember(member));
            UpdateName();
        }

        public override void AddStipulation(Stipulation stipulation)
        {
            ModifierControl.AddModifier(Match, stipulation);
        }

        protected override bool VerifySegment()
        {
