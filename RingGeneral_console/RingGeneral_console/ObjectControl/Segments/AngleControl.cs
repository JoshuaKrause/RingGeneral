...
namespace RingGeneral_console
{
    class AngleControl : SegmentControl
    {
        ...
        public void AddMember(Character member, int side, string primarySkills, string secondarySkill)
        {
            ...
            SideList[side - 1].AddMember(new AngleMember(member, primarySkills, secondarySkill));
            UpdateName();
        }
