...
{
    class Character : GameObject, IModifiable
    {
        ...
        // Returns all modifiers combined into a single string.
        public string Modifiers
        {
            get
            {
                ...
                if (SkillModifiers.Length > 0)
                    modifiers.Append(SkillModifiers);
                if (RelationshipModifiers.Length > 0)
                    modifiers.AppendFormat(",{0}", RelationshipModifiers);
                if (GimmickModifiers.Length > 0)
                    modifiers.AppendFormat(",{0}", GimmickModifiers);
